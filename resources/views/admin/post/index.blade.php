...
@section('contents')
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                                ...
                                <tbody>
                                    @foreach ($select as $select)
                                        <tr>
                                            ...
                                            <td>{{$select->news_post_count_count}}</td>
                                            <td ><img style="width:50px;height:50px;" src="{{asset('')}}{{$select->creator_photo}}" alt=""></td>
                ...
                @php $select=App\Models\newsPost::withCount('news_post_count')->where('status',0)->get(); $i=1; @endphp
                <div class="card card-default">
                    <div class="card-header">
                        <div class="card-actions">
                            <a class="" data-action="collapse"><i class="ti-minus"></i></a>
                                    ...
                                    @foreach ($select as $select)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{route('post_restore',$select->slug)}}" onclick="return confirm('resotre')" class="text-inverse" title="" data-toggle="tooltip" data-original-title="deactive">
                                                    <i class="mdi mdi-backup-restore"></i>
                                                </a>
                                                <a href="{{route("post_delete",$select->slug)}}" onclick="return confirm('delete')" class="text-inverse" title="" data-toggle="tooltip" data-original-title="deactive">
                                                    <i class="ti-trash"></i>
                                                </a>
                                            </td>
                                        </tr>
