        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">All Latest News</h3>
                </div>
            ...
            <div class="container-fluid">
                ...
                <!-- Start Page Content -->
                <!-- ============================================================== -->
                @php $select=App\Models\newsPost::where('status',1)->where('add_to_latest_news',1)->get(); $i=1; @endphp
                <div class="card card-default">
                    ...
                    <div class="card-body collapse show">
                        <div class="" style="width:100%;overflow-x:scroll;">
                            <table class="table product-overview text-center" id="category_active">
                                <thead>
                                    <tr>
                                        <th>Serial</th>
                                        <th>Headline</th>
