        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">All Banner bottom news</h3>
                </div>
            ...
            <div class="container-fluid">
                ...
                <!-- Start Page Content -->
                <!-- ============================================================== -->
                @php $select=App\Models\newsPost::where('status',1)->where('add_to_top_bottom',1)->get(); $i=1; @endphp
                <div class="card card-default">
                    ...
                    <div class="card-body collapse show">
                        <div class="" tyle="width:100%;overflow-x:scroll;">
                                ...
                                <tbody>
                                    @foreach ($select as $select)
                                        <tr>
                                            ...
                                            <td>
                                                <label class="button">
                                                    @php $j=$select->add_to_top_bottom; if($j==1) $url1='data-url';else $url1='';@endphp
                                                    @php $j=$select->add_to_top_bottom; if($j==0) $url2='data-url';else $url2='';@endphp
                                                    <input type="checkbox" id="{{$select->slug}}" {{$url1}}="{{route("remove_from_top_bottom",$select->slug)}}" {{$url2}}="{{route("add_to_top_bottom",$select->slug)}}">
