                            ...
                            <div class="row">
                                <div class="col-xlg-2 col-lg-3 col-md-4">
                                    <div class="card-body inbox-panel"><a href="app-compose.html" class="btn btn-danger m-b-20 p-10 btn-block waves-effect waves-light">Compose</a>
                                        ...
                                        <li class="list-group-item active"> <a href="{{url('/admin/message')}}"><i class="mdi mdi-gmail"></i> Inbox </a><span class="badge badge-primary ml-auto">{{$count}}</span></li>

                                            <li class="list-group-item">
                                                <a href="{{url('/admin/message/trash')}}"> <i class="mdi mdi-delete"></i> Trash </a><span class="badge badge-success ml-auto">{{$countTrash}}</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="col-xlg-10 col-lg-9 col-md-8 bg-light-part b-l">
                                    <form action="{{ url('/admin/message/soft_delete_multiple/{id}') }}" method="post">
                                        {!! csrf_field() !!}
                                        <div class="card-body">
                                                        ...
                                                        <tbody>
                                                            @foreach ($all as $data)
                                                                <tr class="unread">
                                                                    ...
                                                                    <td class="max-texts">
                                                                        <a href="{{url('/admin/message/view/'.$data->slug)}}" title="{{$data->email}}( visit full massage )">
