	...
	<div class="artigo-content-wrap" >
		...
		<div class="artigo-container">
			...
			<div class="artigo-content-holder" style="padding-right:30px;">
				...
				<div class="artigo-row myGallery">
                        ...
                        <div class="artigo-col-6">
                            <article class="artigo-blog-item format-standard">
                                <div class="entry-thumbnail" >
                                    ...
                                    <a class="venobox post-thumbnail post-tmb2" data-vbtype="iframe" data-gall="myGallery" style="height:100%;" title="this is image" href="{{$item->link}}">
                                        <img style="width:100%;" src="{{asset('')}}{{$item->thumb}}" alt="Video Gallery">
                                    </a>
